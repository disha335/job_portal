...
<html lang="en">
  ...
  <body>
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item cta mr-md-2"><a href="new-post.php" class="nav-link">Need a Job</a></li>
	          <li class="nav-item cta cta-colored"><a href="admin/admin_login.php" class="nav-link">Post a Job</a></li>
    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('img/job.png');" data-stellar-background-ratio="0.5">
    ...
    <section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url(img/job.png;" data-stellar-background-ratio="0.5">
    	<div class="container">
        ...
        <div class="container">
          <div class="row d-flex justify-content-center">
            <div class="col-md-7 text-center heading-section heading-section-white ftco-animate">
              ...
              <p>We will provide you with your best..</p>
